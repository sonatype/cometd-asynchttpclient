...
public class BayeuxLoadGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.addRequestFilter(new ThrottleRequestFilter(40000));
    ...
    private class LoadBayeuxClient extends BayeuxClient {
        ...
        private void notifyServer(final String channelName) throws InterruptedException {
            ...
            publish(channelName, new HashMap<String, Object>(), null);
            latch.await();
        }
    }
}
